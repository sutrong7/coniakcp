...
(function (window, document, $, undefined) {
    ...
    let didUpdate = null;
    const isTouch = document.createTouch !== undefined,
    ...
    $.extend(F, {
        ...
        getViewport: function () {
            const locked = (F.current && F.current.locked) || false,
                rez = {
                    x: W.scrollLeft(),
                    y: W.scrollTop()
                };
        ...
        trigger: function (event, o) {
            let ret;
            const obj = o || F.coming || F.current;
        ...
        _setDimension: function () {
            ...
            const scrolling = current.scrolling,
    ...
    F.transitions = {
        getOrigPosition: function () {
            ...
            let orig = current.orig,
                pos = {},
                width = 50,
                height = 50;
            const hPadding = current.hPadding,
        ...
        zoomIn: function () {
            ...
            const effect = current.openEffect,
